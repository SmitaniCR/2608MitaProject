...
class BookServiceTest {
    ...
    void setUp() {
        ...
        bookRequest = new BookRequest("新テスト","テス太","2222222222222",100L,10,10,"新テテテ",LocalDate.of(2026, 8, 27), null, null);
    }
    ...
    void create_カテゴリIDがnullのときカテゴリなしで登録できる() {
    	BookRequest noCategoryRequest = new BookRequest("タイトル", "著者", "ISBN", null, 5, 5, "説明", LocalDate.now(), null, null);
        when(bookRepository.save(any(Book.class))).thenAnswer(invocation -> invocation.getArgument(0));
